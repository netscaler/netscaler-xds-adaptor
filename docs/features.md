...
| [http.fault.delay.percentage](https://istio.io/docs/reference/config/networking/virtual-service/#HTTPFaultInjection-Delay) | 1.2.1+          | 13.0–58.22+  | 
| [http.fault.delay.fixedDelay](https://istio.io/docs/reference/config/networking/virtual-service/#HTTPFaultInjection-Delay) | 1.2.1+          | 13.0–58.22+  | 
